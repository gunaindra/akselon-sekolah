	<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?php echo site_url("penjadwalan"); ?>"><?php echo $title; ?></a>
					</li>
				</ul>
...
<script type="text/javascript">
       ...
       var dataTable = $('#datatableTable').DataTable( {
					...
					"ajax":{
						url :"<?php echo site_url("penjadwalan/grid"); ?>", 
						type: "post", 
						"data": function ( data ) {
	...
	$(document).off('click', '#simpanjadwal').on('click', '#simpanjadwal', function (event, messages) {	
	  ...
	  if(hari =="" || jam =="" || mapel=="" || tmguru_id==""){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url("penjadwalan/save"); ?>",
   ...
   $(document).off('click', '.deleteone').on('click', '.deleteone', function (event, messages) {			
	    ...
	    alertify.confirm("Apakah anda yakin akan menghapus data ini ?",function(){
		 loading();
			 $.post("<?php echo site_url("penjadwalan/hapus"); ?>",{id:id},function(data){

...
class Model_data extends CI_Model {
	...
	public function update($id) {
			...
			$this->Acuan_model->log($_SESSION['nama']." Update Berita");	
				if ($this->db->trans_status() === FALSE) {
					$this->db->trans_rollback();

<?php $attributes = array('class' => 'form-horizontal', 'role'=>'form','name' => 'simpan', 'id' => 'simpanberita', 'method' => "post", 'url' =>site_url("berita/save")); ?>
						           ...
						           <div class="row" style="display: none;" id="errorvalidation">
									 ...
									 <div class="form-group">
											 ...
											 <div class="col-md-9">
													...
													<input type="text"  name="f[judul]" value="<?php echo isset($dataform->judul) ? $dataform->judul:"";  ?>" placeholder=" Judul Berita " class="form-control"  >
									  ...
									  <div class="form-group">
											 ...
											 <div class="col-md-9">
													...
													<div name="summernote" id="summernote_1" class="summernote"><?php echo isset($dataform->isi) ? $dataform->isi:"";  ?></div>						
											</div>
									 </div>
									 
									   <div class="form-group">
											 <label class="col-md-3 control-label" style="text-align:left"> Gambar    <span class="required"></span></label>
											 <div class="col-md-9">

                                <div class="form-group">
									 ...
									 <div class="form-group">
											 ...
											 <div class="col-md-4">
												...
												<input type="text" readonly class="form-control" id="tgl_lahir" name="s[tgl_lahir]" value="<?php echo isset($dataform) ? $this->Acuan_model->formattanggalstring($dataform->tgl_lahir) : ""; ?>">							

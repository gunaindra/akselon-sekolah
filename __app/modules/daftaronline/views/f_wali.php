									 ...
									 <div class="form-group">
											 ...
											 <div class="col-md-4">
												...
												<input type="text" readonly class="form-control" id="tgl_lahir_wali" name="p[tgl_lahir_wali]" value="<?php echo isset($dataform) ? $this->Acuan_model->formattanggalstring($dataform->tgl_lahir_wali) : ""; ?>">							

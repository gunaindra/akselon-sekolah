									 ...
									 <div class="form-group">
											 ...
											 <div class="col-md-4">
												...
												<input type="text" readonly class="form-control" id="tgl_lahir_ayah" name="p[tgl_lahir_ayah]" value="<?php echo isset($dataform) ? (!empty($dataform->tgl_lahir_ayah)) ? $dataform->tgl_lahir_ayah : date("Y-m-d") : date("Y-m-d"); ?>">							

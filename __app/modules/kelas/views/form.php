<?php $attributes = array('class' => 'form-horizontal', 'role'=>'form','name' => 'simpan', 'id' => 'simpan', 'method' => "post", 'url' =>site_url("kelas/save")); ?>
						           ...
						           <div class="row" style="display: none;" id="errorvalidation">
									 ...
									 <div class="form-group">
											 ...
											 <div class="col-md-9">
													...
													<input type="text"  name="f[nama]" value="<?php echo isset($dataform->nama) ? $dataform->nama:"";  ?>" placeholder="ex : Kelas VII" class="form-control"  >

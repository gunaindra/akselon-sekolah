	<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?php echo site_url("lapkembalibuku"); ?>">Laporan Pengembalian Buku</a>
					</li>
				</ul>
								  ...
								  <div class="col-md-9">
									<form class="navbar-form navbar-right" role="search" method="post" id="formcaridatatables" action="javascript:void(0)">
										...
										<div class="form-group">
											<input type="text" size="30" name="keyword" id="keyword" class="form-control" placeholder="Judul Buku " value="<?php echo isset($keyword) ? $keyword :""; ?>" placeholder=" ">
...
<script type="text/javascript">
        ...
        var dataTable = $('#datatableTable').DataTable( {
					...
					"ajax":{
						url :"<?php echo site_url("lapkembalibuku/grid"); ?>", 
						type: "post", 
						"data": function ( data ) {

											...
											<?php 
											 ...
											 ?>
											  <tr id="peminjaman<?php echo $val->trbuku_id; ?>">
													...
													<td width="10%"> <?php echo '<a href="javascript:;" class="btn btn-danger kembalikan tooltips" data-container="body" data-placement="top" title="Kembalikan Buku" datanya="'.$val->trbuku_id.'"><i class="fa fa-check-circle"></i></a>'; ?> </td>
											   </tr>

<?php $attributes = array('class' => 'form-horizontal', 'role'=>'form','name' => 'simpan', 'id' => 'simpan', 'method' => "post", 'url' =>site_url("grup/save")); ?>
						...
						<div class="portlet-body" id="headerawal">
						           ...
						           <div class="row" style="display: none;" id="errorvalidation">
									 ...
									 <div class="form-group">
											 <label class="col-md-3 control-label" style="text-align:left"> Nama Group <span class="required">*</span></label>
											 <div class="col-md-9">
												
													<input type="text"  name="f[nama]" value="<?php echo isset($dataform->nama) ? $dataform->nama:"";  ?>" placeholder="ex : Staff Keuangan" class="form-control"  >

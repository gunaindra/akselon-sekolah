<?php $attributes = array('class' => 'form-horizontal', 'role'=>'form','name' => 'simpan', 'id' => 'simpan', 'method' => "post", 'url' =>site_url("pekerjaan/save")); ?>
						...
						<div class="portlet-body" id="headerawal">
						           ...
						           <div class="row" style="display: none;" id="errorvalidation">
									 ...
									 <div class="form-group">
											 <label class="col-md-3 control-label" style="text-align:left"> Pekerjaan <span class="required">*</span></label>
											 <div class="col-md-9">
												
													<input type="text"  name="f[nama]" value="<?php echo isset($dataform->nama) ? $dataform->nama:"";  ?>" placeholder="ex : Wiraswasta" class="form-control"  >

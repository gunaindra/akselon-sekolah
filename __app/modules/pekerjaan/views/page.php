	<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?php echo site_url("pekerjaan"); ?>">Master Pekerjaan</a>
					</li>
				</ul>
						...
						<div class="portlet-body">
							...
							<div class="row">
								<div class="col-md-12 col-sm-12">
								  <div class="col-md-3">
								    <a href="javascript:void(0);" id="tambahdata"  urlnya="<?php echo site_url("pekerjaan/form"); ?>"class="btn btn-success tooltips" data-container="body" data-placement="right" title="Tambah Data"><i class="fa fa-plus"></i> Tambah Data</a>
								  </div>
								  <div class="col-md-9">
...
<script type="text/javascript">
       ...
       var dataTable = $('#datatableTable').DataTable( {
					...
					"ajax":{
						url :"<?php echo site_url("pekerjaan/grid"); ?>", 
						type: "post", 
						"data": function ( data ) {

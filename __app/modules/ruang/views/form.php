<?php $attributes = array('class' => 'form-horizontal', 'role'=>'form','name' => 'simpan', 'id' => 'simpan', 'method' => "post", 'url' =>site_url("ruang/save")); ?>
						...
						<div class="portlet-body" id="headerawal">
						           ...
						           <div class="row" style="display: none;" id="errorvalidation">
									 ...
									 <div class="form-group">
											 ...
											 <div class="col-md-9">
												  <select class="form-control onchange" name="f[tmjenjang_id]" url="<?php echo site_url("ruang/selectkelas"); ?>" target="tmkelas_id">

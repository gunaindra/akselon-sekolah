	<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?php echo site_url("kalender"); ?>">Kalender Akademik</a>
					</li>
				</ul>
								...
								<div class="col-md-12 col-sm-12">
								  <div class="col-md-3">
                                      <?php if (isset($privileges->c_create) && $privileges->c_create == '1'): ?>
                                        <a href="javascript:void(0);" id="tambahdata"  urlnya="<?php echo site_url("kalender/form"); ?>" class="btn btn-success tooltips" data-container="body" data-placement="right" title="Tambah Data"><i class="fa fa-plus"></i> Tambah Data</a>
                                      <?php endif; ?>
								  </div>
								  <div class="col-md-9">
									<form class="navbar-form navbar-right" role="search" method="post" id="formcaridatatables" action="javascript:void(0)">
										...
										<div class="form-group">
											<input type="text" size="30" name="keyword" id="keyword" class="form-control" placeholder="Cari Kegiatan" value="<?php echo isset($keyword) ? $keyword :""; ?>" placeholder=" ">
...
<script type="text/javascript">
        ...
        var dataTable = $('#datatableTable').DataTable( {
					...
					"ajax":{
						url :"<?php echo site_url("kalender/grid"); ?>", 
						type: "post", 
						"data": function ( data ) {

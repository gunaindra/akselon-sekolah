...
class Model_data extends CI_Model {
    ...
    public function __construct() {
	 ...
	 private $table    ="akademik.tm_kalender";
	...
	public function getdata($paging){
	    ...
	    if($keyword !=""){ $this->db->where("UPPER(kegiatan) LIKE '%".strtoupper($keyword)."%'"); }
	 ...
	 public function insert() {
			...
			$this->Acuan_model->log($_SESSION['nama']." Entry Kalender Akademik ");	
	...
	public function update($id) {
			...
			$this->Acuan_model->log($_SESSION['nama']." Update Kalender Akademik");	
				if ($this->db->trans_status() === FALSE) {
					$this->db->trans_rollback();

	<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?php echo site_url("jenjang"); ?>">Jenjang Pendidikan</a>
					</li>
				</ul>
								...
								<div class="col-md-12 col-sm-12">
								  <div class="col-md-3">
                                      <?php if (isset($privileges->c_create) && $privileges->c_create == '1'): ?>
                                          <a href="javascript:void(0);" id="tambahdata"  urlnya="<?php echo site_url("jenjang/form"); ?>"class="btn btn-success tooltips" data-container="body" data-placement="right" title="Tambah Data"><i class="fa fa-plus"></i> Tambah Data</a>
                                      <?php endif; ?>
								  </div>
								  <div class="col-md-9">
...
<script type="text/javascript">
       ...
       var dataTable = $('#datatableTable').DataTable( {
					...
					"ajax":{
						url :"<?php echo site_url("jenjang/grid"); ?>", 
						type: "post", 
						"data": function ( data ) {
